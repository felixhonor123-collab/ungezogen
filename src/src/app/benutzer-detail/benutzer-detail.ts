...
export class BenutzerDetail implements OnInit {
  ...
  nameBearbeitenStarten() {
    ...
    this.editSpitzname.set(b.spitzname ?? '');
  ...
  nameBearbeitenSpeichern() {
    ...
    this.schuldService
      .benutzer_bearbeiten(id, this.editVorname().trim(), this.editNachname().trim(), this.editTelefon().trim(), this.editBezeichnung().trim(), this.editSpitzname().trim())
      .subscribe((b) => {
        this.benutzer.set(b);
